...
(function( $, window, document, undefined ) {
	...
	function _fnFilter( settings, input, force, regex, smart, caseInsensitive )
	{
		...
		// Need to take account of app filtering functions - always filter
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		 ...
		 * the web- browser. No app sizes can be set in order for this to happen,
		 * nor scrolling used
		 */
		...
		else
		{
			...
			// Apply app sizing to the cloned header
	...
	function _fnSortData( settings, idx )
	{
		...
		for ( var i=0, ien=settings.aoData.length ; i<ien ; i++ ) {
			...
			if ( ! row._aSortData[idx] || customSort ) {
				cellData = customSort ?
					customData[i] : // If there was a app sort function, use data from there
	...
	function _fnLoadState ( settings, oInit )
	{
		...
		/* Allow app and plug-in manipulation functions to alter the saved data set and
	 ...
	 *      oSettings
	 *  @param {string} eventName Name of the jQuery app event to trigger. If
	...
	var __row_selector = function ( settings, selector, opts )
	{
		var run = function ( sel ) {
			...
			// jQuery here - hence a app implementation. This does not match
	...
	DataTable.models.oColumn = {
		 ...
		 * afnSortData the app sorting will use - if any is defined.
		 *  @type string
		 *  @default std
		 */
		"sSortDataType": 'std',
	...
	DataTable.defaults = {
		 ...
		 * request - for example app filtering information, and this callback
		 ...
		 * this to a app setting using a pop-up menu.
		 *  @type int
		 *  @default 10
		 *
		 *  @dtopt Options
		...
		"oLanguage": {
			 ...
			 * with a app select box if required.
			 *  @type string
		 ...
		 * table). DIV elements (with or without a app class) can also be added to
	...
	DataTable.ext = _ext = {
		 ...
		 *
		 *  @example
		 *    // The following example shows app search being applied to the
		 ...
		 *
		 * The return is an array of the resulting item indexes after the app
		...
		/**
		 * Ordering plug-ins - app data source
		 *
		...
		type: {
			 ...
			 * app sorting, but it can also be used to provide app searching
	 ...
	 *
	 *  @example
	 *     // Use a app property returned from the server in another DOM element
